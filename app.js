/* Program Finder
   - Data embedded directly (no external JSON file needed)
   - Provides grade + format filters and search
   - Default view is school programs only
*/

const DATA = {
  "orgName": "Puget Sound Estuarium",
  "pageTitle": "K–12 Program Finder",
  "ctaEstimateUrl": "#estimate",
  "ctaInquiryUrl": "#inquire",
  "programs": [
    {
      "name": "Sound Sprouts",
      "grades": "PreK",
    ...
    },
    {
      ...
      "formats": {
        ...
        "4-week": false,
        "5-day camp": false,
        "1-day field trip": false
      },
      "notes": {}
    },
    {
      "name": "SoundCore Exchange",
      "grades": "13+",
      "category": "Community/Adult",
      "formats": {
        "10-week": false,
